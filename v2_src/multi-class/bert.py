...
#     )
    ...
    #             loss=outputs.loss
        ...
        accelerator.print("")
        accelerator.print("avg_loss: {:.6f} | accuracy: {:.2%} | F1-Score(micro) {:.2%} | F1-Score(macro) {:.2%} | F1-Score(weighted) {:.2%}  | roc-auc(micro) {:.2%} | roc-auc(macro) {:.2%}  | roc-auc(weighted) {:.2%}  | pr-auc(maicro) {:.2%} | pr-auc(macro) {:.2%} | pr-auc(weighted) {:.2%}  | Elapsed: {:}".\
...
if __name__=="__main__":
    ...
    train_df=cate_2_int_label(train_df,col="new_category")
    val_df=cate_2_int_label(val_df,col="new_category")
    test_df=cate_2_int_label(test_df,col="new_category")
